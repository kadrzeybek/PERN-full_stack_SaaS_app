...
const Community = () => {
  ...
  return !loading ? (
    <div className='flex flex-1 h-full flex-col gap-4 p-6'>
      Creations
      <div className='h-full w-full  rounde-xl rounded-xl bg-white overflow-y-auto max-h-[85vh]'>
        {
          creations.map((creation, index) => (
            <div key={index} className='relative group inline-block p-3 w-full sm:max-w-1/2 lg:max-w-1/4'>
