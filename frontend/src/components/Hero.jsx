...
const Hero = () => {
  ...
  return (
    <div className="inline-flex flex-col w-full justify-center px-4 sm:px-20 xl:px-32 relative bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen">
